...
export const rawAttendanceRecords: (Omit<AttendanceRecord, 'entryTime' | 'exitTime' | 'status'> & {time: string, eventType: 'Entry' | 'Exit' | 'Absent', employeeName: string, department: string, status: AttendanceRecord['status']})[] = [
